...
static const flex_int16_t yy_base[28] =
    {   0,
        0,    0,   40,   32,    0,   35,    8,   16,   30,   29,
        0,    0,    0,    0,   19,   29,   22,   28,   27,   25,
       26,   20,   13,   12,   41,   10,    8
    } ;

static const flex_int16_t yy_def[28] =
    {   0,
       25,    1,   25,   26,   27,   27,   25,   25,   26,   26,
       27,    6,    7,    7,    8,    8,   26,    8,    8,   17,
       20,   20,   20,   20,    0,   25,   25
    } ;

static const flex_int16_t yy_nxt[50] =
    {   0,
        4,    5,    6,    7,    7,    8,    7,    7,    9,   11,
        9,   13,   13,    9,   14,   13,    9,   24,   23,    9,
       15,   16,   10,   17,   18,   24,    9,   20,   10,   21,
       22,   23,   19,   18,   19,   10,   10,   12,   10,   25,
        3,   25,   25,   25,   25,   25,   25,   25,   25
    } ;

static const flex_int16_t yy_chk[50] =
    {   0,
        1,    1,    1,    1,    1,    1,    1,    1,    7,   27,
       26,    7,    7,    7,    7,    7,    8,   24,   23,    8,
        8,    8,    8,    8,   15,   22,   15,   17,   17,   20,
       20,   21,   19,   18,   16,   10,    9,    6,    4,    3,
