...
static const flex_int16_t yy_base[21] =
    {   0,
        0,    0,   24,   17,    0,   19,    7,   14,   11,    0,
        0,    0,    0,    0,    0,   11,    0,   25,    9,    7
    } ;

static const flex_int16_t yy_def[21] =
    {   0,
       18,    1,   18,   19,   20,   20,   18,   18,   19,    9,
       20,    6,    7,    7,    8,    9,   16,    0,   18,   18
    } ;

static const flex_int16_t yy_nxt[33] =
    {   0,
        4,    5,    6,    7,    8,    7,    7,    9,   11,    9,
       13,    9,   14,   13,    9,   17,   10,    9,   15,   10,
       16,   12,   10,   18,    3,   18,   18,   18,   18,   18,
       18,   18
    } ;

static const flex_int16_t yy_chk[33] =
    {   0,
        1,    1,    1,    1,    1,    1,    1,    7,   20,   19,
        7,    7,    7,    7,    8,   16,    9,    8,    8,    8,
        8,    6,    4,    3,   18,   18,   18,   18,   18,   18,
       18,   18
    } ;
